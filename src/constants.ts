...
export const CONTACT_INFO = {
  ...
  mapLink:
    "https://yandex.com/maps/org/shokolad/72528152002/?ll=58.981037%2C53.361071&z=17",
...
export const FEATURES = [
  {
    title: "Вкусная кухня",
    description:
      "Традиционные русские блюда и самые необычные — из семейных поваренных книг.",
    icon: "Utensils",
  },
  {
    title: "Отличный интерьер",
    description:
      "Уютный банкетный зал с очень душевной атмосферой для ваших памятных событий.",
    icon: "Home",
  },
  {
    title: "Оформление в подарок",
    description:
      "Стильное оформление зала для подписчиков нашей группы ВК — в подарок!",
    icon: "Gift",
  },
  {
    title: "Эффектные фото-зоны",
    description:
      "Продуманные локации для создания самых красивых и запоминающихся снимков.",
    icon: "Camera",
  },
  {
    title: "Гуманные цены",
