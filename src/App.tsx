    ...
    <div className="min-h-screen selection:bg-chocolate-light selection:text-white">
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-full -z-10 opacity-10">
          <Infinity className="w-full h-full text-chocolate-light" strokeWidth={0.5} />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="max-w-2xl mx-auto text-lg md:text-xl text-chocolate-medium/80 mb-10 leading-relaxed">
              ...
              Доверьте нам организацию вашего торжества.
            </p>
      ...
      <section className="py-24 md:py-32">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-20">
            <h2 className="font-display text-4xl md:text-6xl font-bold text-chocolate-dark mb-6 italic">Почему выбирают нас</h2>
          ...
          <div className="flex flex-col md:flex-row items-center gap-16">
            <div className="flex-1 space-y-8">
              ...
              <p className="text-xl opacity-80 leading-relaxed max-w-lg">
                Станьте подписчиком нашей группы ВКонтакте и получите качественное, 
                стильное оформление банкетного зала совершенно бесплатно. 
                Пусть ваш праздник будет идеальным до мельчайших деталей!
              </p>
              <a 
                href={CONTACT_INFO.vkLink}
                target="_blank"
      ...
      <section className="py-32 bg-chocolate-cream">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:h-[600px]">
            ...
            >
               <p className="text-white font-display italic text-5xl font-bold mb-3 group-hover:scale-105 transition-transform">Смотреть больше</p>
      ...
      <section className="py-24 text-center">
        <div className="max-w-4xl mx-auto px-4 space-y-8">
          ...
          <p className="text-xl text-chocolate-medium/70">
            Мы будем счастливы, если вы доверите нам организацию вашего торжества. 
            Поводов много — праздник один!
          </p>
          <a 
            href={`tel:${CONTACT_INFO.phone.replace(/[^+\d]/g, '')}`}
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-12">
            <div className="space-y-6 text-center md:text-left">
              ...
              <p className="max-w-xs text-chocolate-medium/60 text-sm leading-relaxed mx-auto md:mx-0">
                Банкетный зал с душевной атмосферой в самом сердце Магнитогорска. 
                Мы делаем ваши праздники незабываемыми.
              </p>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 md:gap-16 w-full md:w-auto">
              <div className="space-y-4">
                <h4 className="text-xs font-bold uppercase tracking-widest text-chocolate-light">Контакты</h4>
                <ul className="space-y-3">
                  <li>
                    ...
                    >
                      ...
                      <span className="font-medium group-hover:underline underline-offset-4">{CONTACT_INFO.address}</span>
                    </a>
                  </li>
                  <li>
                    <a 
              ...
              <div className="space-y-4">
                <h4 className="text-xs font-bold uppercase tracking-widest text-chocolate-light">Мы в соцсетях</h4>
                <a 
                  href={CONTACT_INFO.vkLink}
                  target="_blank"
                  rel="noopener noreferrer"
